...
Light_t Light_fish_shadow_geo_0x301b5d0 = {
{ 255, 255, 255}, 0, { 255, 255, 255}, 0, { 40, 40, 40}, 0
};

Ambient_t Light_fish_shadow_geo_0x301b5c8 = {
{63, 63, 63}, 0, {63, 63, 63}, 0
};

Gfx DL_fish_shadow_geo_0x301bfb8[] = {
gsDPPipeSync(),
...
Gfx DL_fish_shadow_geo_0x301bec0[] = {
...
Gfx DL_fish_shadow_geo_0x301c150[] = {
gsDPPipeSync(),
gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, SHADE, TEXEL0, 0, SHADE, 0, 0, 0, 0, SHADE),
gsDPSetTile(0, 2, 0, 0, 7, 0, 0, 0, 0, 0, 0, 0),
gsSPTexture(65535, 65535, 0, 0, 1),
...
Gfx DL_fish_shadow_geo_0x301c0a8[] = {
gsDPSetTextureImage(0, 2, 1, fish_shadow_geo__texture_0301B5E0),
gsDPLoadSync(),
gsDPLoadBlock(7, 0, 0, 1023, 256),
gsSPLight(&Light_fish_shadow_geo_0x301b5d0.col, 1),
