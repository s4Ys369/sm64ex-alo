...
LOAD_MODEL_FROM_GEO(MODEL_HMC_METAL_PLATFORM,       bob_platform_geo),
LOAD_MODEL_FROM_GEO(MODEL_HMC_METAL_ARROW_PLATFORM, hmc_geo_0005B8),
LOAD_MODEL_FROM_GEO(MODEL_HMC_ELEVATOR_PLATFORM,    hmc_geo_0005D0),
LOAD_MODEL_FROM_GEO(MODEL_HMC_ROLLING_ROCK,         hmc_geo_000548),
LOAD_MODEL_FROM_GEO(MODEL_HMC_RED_GRILLS,           hmc_geo_000570),
...
OBJECT_WITH_ACTS(MODEL_HMC_RED_GRILLS,-4781,-2004,2280,0,0,0,0x0, bhvChainChomp,63),
OBJECT_WITH_ACTS(MODEL_HMC_RED_GRILLS,-3666,-2004,1825,0,0,0,0x0, bhvChainChomp,63),
OBJECT_WITH_ACTS(MODEL_HMC_RED_GRILLS,-5901,-2004,2481,0,0,0,0x0, bhvChainChomp,63),
OBJECT_WITH_ACTS(MODEL_HMC_RED_GRILLS,-5647,-2004,3624,0,0,0,0x0, bhvChainChomp,63),
OBJECT_WITH_ACTS(MODEL_HMC_RED_GRILLS,-5509,-2004,942,0,0,0,0x0, bhvChainChomp,63),
...
OBJECT_WITH_ACTS(54,1196,595,3189,0,0,0,0x0, bhvSquishablePlatform,63),
OBJECT_WITH_ACTS(54,2756,937,3529,0,0,0,0x0, bhvSquishablePlatform,63),
OBJECT_WITH_ACTS(54,4057,-1613,516,0,0,0,0x0, bhvSquishablePlatform,63),
